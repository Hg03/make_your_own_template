...
Also add the hatchling part in the pyproject and include the src/{project_name} at packages parameter also. Don't include any extra explanations or something, just give me pyproject.toml code only.
